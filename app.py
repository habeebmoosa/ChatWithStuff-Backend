...
from services.document import router as documentRouter
from services.webpage import router as webpageRouter
from services.excel import router as excelRouter
...
app.include_router(webpageRouter, prefix="/webpage", tags=["Webpage"])
app.include_router(excelRouter, prefix="/excel", tags=["Spreadsheet"])
